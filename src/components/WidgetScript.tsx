...
export function WidgetScript({ companyId }: { companyId: string }) {
  ...
  // Don't show widget on admin pages, login, register, onboarding, invite pages, or widget preview
  const excludedPaths = ['/admin', '/logg-inn', '/registrer', '/onboarding', '/invite', '/transfer', '/widget']
